...
import { Mail, Clock, ArrowLeft } from "lucide-vue-next";
...
async function loadTransactions() {
  ...
  try {
    const response = await $fetch<{ transactions: TokenTransaction[] }>(
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-2xl border border-stone-200 p-6">
            <div class="flex items-center gap-4">
              <div
                class="w-16 h-16 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full flex items-center justify-center"
              >
          ...
          <div class="bg-white rounded-2xl border border-stone-200 p-6">
            ...
            <div v-if="isLoadingTransactions" class="space-y-3">
              <div
                v-for="i in 3"
                :key="i"
                class="h-12 bg-stone-100 rounded-lg animate-pulse"
              />
            </div>
            ...
            <div v-else class="space-y-3">
              ...
              >
                ...
                <span
                  :class="['font-semibold', getTransactionTypeClass(tx.type)]"
                >
